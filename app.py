...
dict1 = {
    ...
    "Diagonosis":{"D001":0,"D002":1,"D003":2,"D004":3},
...
def predict():
    data = request.get_json()   # in dictionary
    
    # covert user input into df and preprocess categorical value
    df = preprocess_input(data)
    
    # make predict
    prediction = model.predict(df)[0]  # 0 1

    # we show meassage base on prediction
